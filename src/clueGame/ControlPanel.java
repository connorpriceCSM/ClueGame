	...
	implements ActionListener
	{
		...
		{}
			...
			public void actionPerformed(ActionEvent action) {
				if(action.getSource() == nextPlayer)
				{
					ControlPanel.this.nextPlayer();
				}
		...
		public void nextPlayer()
		{
			...
			Board.getInstance().nextPlayerTurn();
		}

		public void showTurn(String playerName, int roll)
		{
			whoseTurn.setText(playerName);
			dieRoll.setText(String.valueOf(roll));
		}

		public void setGuess(String guess)
		{
			guessMade.setText(guess);
		}
